...
do
	...
	then
		...
		cd $workpath/cfg/zhongshan_hi3716H
		chmod 777 -Rf *
                make clean > /dev/null 2>&1
                ...
                then
                        flag=1
                        rm $workpath/lib/$plat/$mod/libcfg_zhongshan_hi3716H.a -f
                        echo ===================== cfg/zhongshan_hi3716H make failed message is :  ========================
                        tail -10 $log_file_detail
                        echo ===================== cfg/zhongshan_hi3716H make failed message is :  =================== >> $log_file
                        tail -10 $log_file_detail >>  $log_file
                else
                	echo ===================== cfg/zhongshan_hi3716H make success ========================
                        echo ===================== cfg/zhongshan_hi3716H make success ======================== >> $log_file
                fi

		cd $workpath/cfg/zhongshan_3rd_hi3716H
                chmod 777 -Rf *
                make clean > /dev/null 2>&1
                make  >> $log_file_detail  2>&1
                if [ $? -ne 0 ]
                then
                        flag=1
                        rm $workpath/lib/$plat/$mod/libcfg_zhongshan_3rd_hi3716H.a -f
                        echo ===================== cfg/zhongshan_3rd_hi3716H make failed message is :  ========================
                        tail -10 $log_file_detail
                        echo ===================== cfg/zhongshan_3rd_hi3716H make failed message is :  ================ >> $log_file
                        tail -10 $log_file_detail >>  $log_file
                else
                        echo ===================== cfg/zhongshan_3rd_hi3716H make success ========================
                        echo ===================== cfg/zhongshan_3rd_hi3716H make success ======================== >> $log_file
                fi


	else
		echo ===================== the current cbb is other:$mdlcbb
		echo "------------------------ the current cbb is other:$mdlcbb ----------------------------- " >> $log_file
        	cd $workpath/$mdlcbb
					chmod 777 -Rf *
        	make clean   >> $log_file_detail  2>&1
        	make  >> $log_file_detail  2>&1
...
echo ====================== flag:$flag,plat:$plat,mod:$mod =====================
echo -e "====================== flag:$flag,plat:$plat,mod:$mod =====================" >> $log_file
if [ "$flag" -eq 1 ]
then
