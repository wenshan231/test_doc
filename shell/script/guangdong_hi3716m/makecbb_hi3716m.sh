...
echo -e "====================== all cbb:$model_list_cbb =====================" 
for mdlcbb in $model_list_cbb
do
	echo $mdlcbb
		echo -e "====================== update cbb:$mdlcbb ====================="
	...
	then
		#cd $workpath/lib/$plat/$mod
		#rm libudi2_caadapter.a -f
		#cp $workpath/lib/hi3716H/$mod/libmis.a . -f
		cd $workpath/$mdlcbb
		echo =====================this is guangdong hi3716m thirdparty/mis========================
		make clean
		make
		make clean
		make config=config_dongguang.txt
