...
apk_list="FlyUI_Account_git FlyUI_BootWizard_git FlyUI_Clean_git FlyUI_HomePlayer2_git FlyUI_IME2.0_git FlyUI_NetCheck_git FlyUI_Portal2.0_git FlyUI_Setting2.0_git FlyUI_VOD_amlogic_git FlyUI_VOD_OTT_DVB_git FlyUI_Wallpaper_git FlyUI_WebApp_git FlyUIWidget_TimeDate_git FlyUIWidget_Weather_git"
