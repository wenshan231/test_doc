...
rm -f amlogics802_porting*.tar.gz
...
#mv $workspace/platform/$pakage_version  $workspace/platform/$pakage_version  && echo "mv $pakage_version ok"  >> $workspace/log_version.txt  || echo "mv $pakage_version error"  >> $workspace/log_version.txt
