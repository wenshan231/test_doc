...
#copy from apk 
#apk_list="FlyUI_Portal FlyUI_VOD FlyUI_HomePlayer FlyUI_BootWizard FlyUI_Live "
...
#copy from apk 
#apk_list="com.coship.app.vaf com.coship.ChangeTheAudioOutput  com.coship.netfirmware com.coship.NetworkNavigation  com.coship.TestApp com.coship.trafficmonitor BluetoothHeadsetICS  com.coship.dvbsetting "
...
apk_list="BootWizard"
src_path=/home/ott-admin/share_99.102/apk
cd $apk_dist_dir
...
do
	...
	echo $pakage_version
        ...
        then
                ...
                cd $apk_dist_dir
		rm -f $pakage_version && cp -f $src_path/$apk_mdl/$last_version/bin/$pakage_version   ./ && cp -f $src_path/$apk_mdl/$last_version/bin/$pakage_version          $workspace/package/ && echo "$i copy $last_version/bin/$pakage_version ok" >> $workspace/log_version.txt || echo "$i copy $last_version/bin/$pakage_version failed" >> $workspace/log_version.txt
