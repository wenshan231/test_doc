...
.HtmlBody="<p>您好！</p>公司产品型号:" & wscript.Arguments(0) & "编译失败，具体参数如下<p>1 测试包名称:" & wscript.Arguments(1) & "</p><p>2 测试包路径:" & wscript.Arguments(2) & "</p><p>3 BL软件包名称:" & wscript.Arguments(3) & "</p><p>4 BL软件包路径:" & wscript.Arguments(4) & "</p><p>5 源代码标签:" & wscript.Arguments(5) & "</p><p>6 源代码路径:" & wscript.Arguments(6) & "</p><p>7 备注信息:" & wscript.Arguments(7) & "</p><p>========================================</p><p><font size=2>配置组</font></p><p ><font size=2>深圳市同洲电子股份有限公司<br />  地址：深圳市南山区高新科技园北区彩虹科技大厦(邮编：518057)<br />   <br />   <br /></font></p>"
