...
echo 现在进入linux中编译，如需查看编译信息请向CMO获取！
call putty.exe root@10.10.5.54 -pw Coshipcm -m "E:\DVB\bat\compile_bat\hmc\make.sh"
...
echo 现在进入linux中编译，如需查看编译信息请向CMO获取！
call putty.exe root@10.10.5.54 -pw Coshipcm -m "E:\DVB\bat\compile_bat\bcm\test.sh" 
echo 在linux中编译完成，已退出linux系统！
call putty.exe root@10.10.5.54 -pw Coshipcm -m "E:\DVB\bat\compile_bat\bcm\chmoddir.sh" 
Y:
...
echo 现在进入linux中编译，如需查看编译信息请向CMO获取！
call putty.exe root@10.10.5.54 -pw Coshipcm -m "E:\DVB\bat\compile_bat\linux\linux_make.sh"
echo 在linux中编译完成，已退出linux系统！

cd "%BATPATH%\%PRODUCT%\%SRCPATH%
REM *检查filelist.txt是否存在！*
set m=1
if exist filelist.txt (
set m=0
