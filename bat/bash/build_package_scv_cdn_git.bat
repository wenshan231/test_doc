...
if exist %SRCPATH%\output\*.exe     goto zipoutputexe
...
dir /b %SRCPATH%\output\*.zip  >>%SRCPATH%\output\list.txt
cd /d %SRCPATH%\output
...
echo -------------->> output\codeline.txt
if exist %SRCPATH%\..\icommon    (
echo icommon   version:>> output\codeline.txt
cd ../icommon

call git rev-parse HEAD >> %SRCPATH%\output\codeline.txt
)
...
call F:\tools\diffcount\diffcount.exe -c  %SRCPATH% > %SRCPATH%\output\codeline.txt
cd/d %SRCPATH%
echo %SRCPATH%   version:>> %SRCPATH%\output\codeline.txt
call git rev-parse HEAD >> %SRCPATH%\output\codeline.txt
echo -------------->> %SRCPATH%\output\codeline.txt
if exist %SRCPATH%\..\icommon    (
echo icommon   version:>> output\codeline.txt
cd ../icommon
...
dir /b %SRCPATH%\output\*.exe  >%SRCPATH%\output\list.txt
