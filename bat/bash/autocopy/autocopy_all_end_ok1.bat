...
set mdl3_path=http://10.10.5.52/Test/SCV500/SCV500R001/SCV500R001B02/SCV500R001B022/CIBN_MovieonLine_svn.1201_ABC.zip
...
:err
echo [error] package must from 5.166 or http://10.10.5.52(if exit package)
pause
exit 1
