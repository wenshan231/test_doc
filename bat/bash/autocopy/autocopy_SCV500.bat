...
svn  mkdir %svn_dir_path%/%product_version% -m "%product_version%"  --username qiaoting --password 789123
...
if  exist "D:\bash\autocopy\tmp\安装文挡"  rd  "D:\bash\autocopy\tmp\安装文挡"  /q /s
svn export %mdl0_path%   "D:\bash\autocopy\tmp\安装文挡"  --username qiaoting --password 789123
svn import  D:\bash\autocopy\tmp\   %svn_dir_path%/%product_version%/doc  -m "%mdl0_path%" --username qiaoting --password 789123
