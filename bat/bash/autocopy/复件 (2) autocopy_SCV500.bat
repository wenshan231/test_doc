...
svn import D:\bash\autocopy\tmp    %svn_dir_path%/%product_version%/doc  -m "svn://10.10.5.66/SCV500/00.doc/SCV500R002"
if not exist D:\bash\autocopy\tmp\用户资料 ( echo [error] D:\bash\autocopy\tmp\用户资料 not exit pls check && exit 1)
